...
Vagrant.configure("2") do |config|
    ...
    config.vm.synced_folder ".", "/data/station", id: "app-folder", owner: "vagrant", group: "vagrant", mount_options: ["dmode=775,fmode=664"]
    ...
    config.vm.provider "virtualbox" do |v|
        v.name = "vagrant-playlist-automation-ng";
        v.memory = 4096
        v.cpus = 4
        v.gui = false
    ...
    config.vm.provision "ansible_local" do |ansible|
        ansible.playbook = "/data/station/ansible/vagrant.yml"
#        ansible.verbose = "v"
        ansible.provisioning_path = "/data/station/ansible"
    end
